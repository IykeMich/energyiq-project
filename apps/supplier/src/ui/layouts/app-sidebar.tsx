...
export function AppSidebar(props: ComponentProps<typeof Sidebar>) {
  ...
  const navTopItems: NavItem[] = [{ title: 'Dashboard', 
    url: `/${slug}/dashboard`, icon: LayoutDashboard }];
  ...
  const navTradeItems: NavItem[] = [
    ...
    { title: 'Inventory', 
      url: `/${slug}/inventory`, icon: Package },
    { title: 'Orders', 
      url: `/${slug}/orders`, icon: Package, activePaths: [`/${slug}/orders`] },
  ];
  ...
  const navComplianceItems: NavItem[] = [
    { title: 'KYC Documents', 
      url: `/${slug}/kyc-documents`, icon: FileCheck },
    {
      title: 'Complaints',
    ...
    { title: 'Audit Logs', 
      url: `/${slug}/audit-logs`, icon: ScrollText },
  ];
  ...
  const navStandaloneItems: NavItem[] = [
    {
      ...
      items: [
        ...
        { title: 'Distributor Analytics', 
          url: `/${slug}/analytics/distributors`,
          //  icon: Users 
        },
        { title: 'Complaint Analytics', 
          url: `/${slug}/analytics/complaints`,
          //  icon: MessageSquareWarning 
        },
        { title: 'Trading Analytics', 
          url: `/${slug}/analytics/trading`,
          //  icon: ArrowLeftRight 
        },
        ...
        { title: 'Distributor Report', 
          url: `/${slug}/reports/distributors`,
          //  icon: Users 
        },
        { title: 'Compliance Report', 
          url: `/${slug}/reports/compliance`,
          //  icon: FileCheck 
        },
        { title: 'Custom Report Builder', 
          url: `/${slug}/reports/custom`,
          //  icon: FileText 
        },
      ],
    },
    // TODO: Team & Permissions has no page yet — link will 404 until that page lands.
    {
      ...
      icon: UserCog,
      items: [{ title: 'Team & Permissions', 
        url: `/${slug}/team-permissions`, 
        // icon: UserCog 
      }],
    },
    { title: 'Settings', 
      url: `/${slug}/settings`, icon: Settings },
    { title: 'Log Out', 
      url: '/logout', icon: LogOut, accent: true },
  ];
