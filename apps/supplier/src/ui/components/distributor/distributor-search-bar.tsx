...
interface DistributorSearchBarProps {
  searchQuery: string;
  onSearchChange: (value: string) => void;
}

/** Top-of-table distributor search pill. */
export function DistributorSearchBar({ searchQuery, onSearchChange }: DistributorSearchBarProps) {
  return (
