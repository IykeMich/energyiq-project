...
import type { Tank } from '@/ui/pages/inventory/tank-monitoring/mocks';
      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-2">
          ...
          <Select value={tankId} onValueChange={(v) => setTankId(v ?? '')}>
            <SelectTrigger className="bg-surface-card border-border-strong data-[size=default]:h-[52px] w-full cursor-pointer rounded-[12px] text-foreground px-5 transition-colors hover:border-brand">
