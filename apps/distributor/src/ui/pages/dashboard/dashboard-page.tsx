...
export function DashboardPage() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Distributor Dashboard</h2>
      ...
      <p className="text-gray-400 text-sm mt-8">
        Stations, tanks, pumps, sales, deliveries, and expenses modules will be built here.
      </p>
    </div>
  );
}
