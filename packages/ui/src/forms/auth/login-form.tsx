...
export function LoginForm() {
  ...
  // TEMP: auth endpoint bypassed — fields still validate via zod, then we navigate.
  // Restore the commented `onSubmit` below (and the imports/hook above) when the endpoint is ready.
  const onSubmit = () => {
    navigate('/dashboard');
  };
