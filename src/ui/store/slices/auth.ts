...
import { authUseCases } from '@/config/container';
import type { AuthUser, LoginType, InitiateRequest, LoginRequest } from '@/domain/auth';
...
export const initiate = createAsyncThunk(
  'auth/initiate',
  async (req: InitiateRequest, { rejectWithValue }) => {
    try {
